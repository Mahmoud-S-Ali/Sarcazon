...
public class ViewDragHelper {
    ...
    private boolean mDragFromAnywhere;
    ...
    public boolean isDragFromAnywhere() {
        return mDragFromAnywhere;
    }

    public void setDragFromAnywhere(boolean dragFromAnywhere) {
        mDragFromAnywhere = dragFromAnywhere;
    }
            ...
            case MotionEvent.ACTION_MOVE: {
                if (mDragState == STATE_DRAGGING) {
                    ...
                    for (int i = 0; i < pointerCount; i++) {
                        ...
                        final View toCapture = mParentView.getChildAt(1);// findTopChildUnder((int) mInitialMotionX[pointerId], (int) mInitialMotionY[pointerId]);
