...
/**
 * Created by test on 10/10/2018.
 */

public class FacebookPlayer extends WebView {
    private FacebookPlayer.FacebookBridging bridging = new FacebookPlayer.FacebookBridging();
    private boolean AUTO_PLAY = false;
    private boolean SHOW_TEXT = false;
    private boolean SHOW_CAPTIONS = false;
    private FacebookPlayer.FacebookListener fbListener;
    ...
    public void initialize(String app_id, String videoUrl, FacebookPlayer.FacebookListener listener){
        if(listener != null){
...
*/
        this.setWebChromeClient(new FacebookPlayer.MyChromeClient());
    }
    ...
    public void setAutoPlayerHeight(Context context) {
        ...
        this.getLayoutParams().height = (int) (displayMetrics.widthPixels * 1.5);
    }
}
